...
<img src="/our_files/img043copy.jpg"  width="200" height="400">
...
<img src="/our_files/project_pipeline.png"  width="600" height="250">

**Tesseract's Basic Architecture:**

<img src="/our_files/tesseract.png"  width="600" height="250">
...
<img src="/our_files/preprocessing_ex.png"  width="430" height="500">
...
3. On the command line, run this line in the /tesstrain directory to begin training:
   ...
   c. The created files and its structure should look like this:
      ...
      <img src="/our_files/created_files_structure.png"  width="200" height="600">
      
   d. LSTMF files should also appear in the /jewett-ground-truth directory:
   
      ![Alt text](/our_files/jtg-lstmf.png?raw=true )
      <img src="/our_files/jtg-lstmf.png"  width="200" height="500">
